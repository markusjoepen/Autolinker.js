...
var Autolinker = function( cfg ) {
    ...
    if( mention !== false && mention !== 'twitter' && mention !== 'instagram' && mention !== 'custom' ) {
        throw new Error( "invalid `mention` cfg - see docs" );
    }

    // Validate the value of the `hashtag` cfg
    var hashtag = this.hashtag;
    if( hashtag !== false && hashtag !== 'twitter' && hashtag !== 'facebook' && hashtag !== 'instagram' && hashtag !== 'custom' ) {
...
Autolinker.matcher.Mention = Autolinker.Util.extend( Autolinker.matcher.Matcher, {
    ...
    matcherRegexes : {
        ...
        "custom": new RegExp( '@[_.' + Autolinker.RegexLib.alphaNumericCharsStr + ']{1,50}', 'g' )
    },
